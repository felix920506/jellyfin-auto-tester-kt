...
- **Stage 3 (Report)** reads `execution_result.json`, runs the report and verification agents through KT channels, and writes `transcript.json`, `transcript_metadata.json`, `report.md`, `browser_evidence.md`, plus `final_report.json` or `human_review_queue.json`.
